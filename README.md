...
### Goals for Version 1:
- Move the easy toggles on the home tab to the top
- keep Total queries, blocked queries, block rate, domains on blocklist and cache size on the home tab only.
